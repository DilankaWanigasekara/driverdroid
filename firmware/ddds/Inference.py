...
from gpsloclib import getCurrentLocation

DEVICE_ID = 'ASD246'
USER_ID = '3'

cnx = connection.MySQLConnection(user='admin', password='password',
                                 host='driverdroid-db.cltr1prnocug.us-east-2.rds.amazonaws.com',
                                 database='driverdroid_db')
...
def sendToDB():
    ...
    sql = "INSERT INTO statistics  (date_time, location, device_id) VALUES (%s, %s, %s)"
    val = (formatted_date, location, DEVICE_ID)
...
predictor = dlib.shape_predictor("/home/pi/driverdroid/ddds/shape_predictor_68_face_landmarks.dat")
(rStart, rEnd) = face_utils.FACIAL_LANDMARKS_IDXS["right_eye"]
print("program_loaded")
...
#####################################################################
            ...
            circles = cv2.HoughCircles(im_gray, cv2.HOUGH_GRADIENT, 1, 1, param1=50, param2=30, minRadius=0, maxRadius=10)
